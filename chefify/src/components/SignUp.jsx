    ...
    <div className="signup-container">
      ...
      <div className="row">
        <div className="input-group">
          ...
          <input type="text" placeholder="Input first name" className="input-field" />
        </div>
        <div className="input-group">
          <label>Last name</label>
          <input type="text" placeholder="Input last name" className="input-field" />
        </div>
      </div>
      
      <div className="input-group">
        <label>Email</label>
        <input type="email" placeholder="example.email@gmail.com" className="input-field" />
      </div>
